...
public class MenuServiceImpl implements MenuService {
    ...
    @Autowired
    private MenuImagesRepository menuImageRepository;
    ...
    @Override
    @Cacheable(value = "menu_item", key = "#menuItemId")
    ...
    public ResponseEntity<CommonResponse> filterMenu(MenuFilterRequest request) {
        ...
        return ResponseEntity.ok(new CommonResponse(
                200,
                "Filter Menus Fetched Successfully",
                MenuResponse.convertToResponse(filteredRestaurant, menuImageRepository)
        ));
    }


    @Override
    @Cacheable(value = "menu_search", key = "#keyword")
